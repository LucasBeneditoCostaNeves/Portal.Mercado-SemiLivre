...
export function AddAddressModal({ open, onClose, onSuccess }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setForm({ cep: '', street: '', number: '', complement: '', city: '', state: '' })
    setErrors({})
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--color-border)]">
        <h2 className="text-base font-bold text-[var(--color-text-primary)]">Novo endereço</h2>
        <button
          type="button"
          onClick={onClose}
          disabled={pending}
