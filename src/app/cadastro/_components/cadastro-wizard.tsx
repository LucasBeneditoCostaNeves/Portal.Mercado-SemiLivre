      ...
      <main className="flex-1 bg-[#18181b] rounded-t-3xl lg:rounded-none flex justify-center">
        <div className="w-full max-w-[480px] px-6 lg:px-8 py-8 lg:py-12">
          ...
          {step === 3 && (
            <>
              <div className="mb-6">
                <h1 className="text-2xl font-bold text-white lg:hidden">Suas preferências</h1>
                <p className="mt-1 text-sm text-zinc-400 lg:hidden">Passo 3 de 3 — preferências</p>
                <h1 className="hidden lg:block text-3xl font-bold text-white">Personalize sua experiência</h1>
                <p className="hidden lg:block mt-1 text-zinc-400">Escolha as categorias que mais combinam com você</p>
              </div>
