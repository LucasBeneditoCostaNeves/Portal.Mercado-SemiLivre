  ...
  return (
    <form action={formAction} noValidate className="flex flex-col gap-4">
      ...
      <div className="flex flex-col items-center gap-2 pt-1 text-sm text-[var(--color-text-secondary)]">
        <p>
          Já tem conta?{' '}
          <Link href="/login" className="text-[var(--color-brand-dark)] hover:underline font-medium">
            Entrar
          </Link>
        </p>
        <Link href="#" className="underline hover:text-[var(--color-text-primary)] transition-colors">
