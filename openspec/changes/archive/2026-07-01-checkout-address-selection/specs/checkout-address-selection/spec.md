...
- **THEN** cada endereço é exibido em um card com: nome do destinatário, logradouro, número, bairro, cidade, estado e CEP
...
- **THEN** o formulário contém os campos: CEP (com máscara), logradouro, número, complemento (opcional), bairro, cidade e estado
...
- **THEN** o sistema navega para o próximo step do checkout (ex.: `/checkout/pagamento`) passando o ID do endereço selecionado

#### Scenario: Retornar ao carrinho
- **WHEN** o usuário clica em "Voltar"
- **THEN** o sistema navega para `/carrinho` sem perda dos itens selecionados
