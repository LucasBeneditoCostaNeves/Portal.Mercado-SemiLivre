...
Especifica os endpoints REST da API de carrinho de compras, incluindo o modelo de dados, listagem, adição (upsert), atualização de quantidade e remoção de itens. Todos os endpoints exigem autenticação JWT.
