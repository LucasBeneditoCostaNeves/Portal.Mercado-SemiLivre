...
Define o comportamento de layout responsivo da página de cadastro (`/cadastro`) em viewports mobile (abaixo de 1024px) versus desktop (1024px e acima). Inclui o banner mobile, efeito de sobreposição do formulário, headings contextualizados por breakpoint, row de features e carregamento prioritário do logo.
