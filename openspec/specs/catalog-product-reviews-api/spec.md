...
Especificação do endpoint público de avaliações de produto na API de catálogo, cobrindo retorno paginado e filtrável de reviews, shape do ReviewItem, distribuição por estrelas e agregação de fotos.
