...
Especificação do histórico de buscas do usuário no frontend, cobrindo a exibição de termos recentes no SearchBar e o registro automático de buscas ao navegar para `/buscar`.
