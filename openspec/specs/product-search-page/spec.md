...
Especificação da página de resultados de pesquisa (`/buscar`), responsável por exibir produtos filtrados por termo de busca com suporte a infinite scroll, estado vazio e loading skeleton.
