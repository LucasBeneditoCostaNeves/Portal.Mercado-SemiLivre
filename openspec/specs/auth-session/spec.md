...
Define o gerenciamento de sessão do usuário autenticado via cookie HTTP-only, incluindo criação, leitura e remoção do token JWT, e a proteção de rotas privadas via middleware.
