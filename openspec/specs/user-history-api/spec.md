...
Especificação dos endpoints de histórico do usuário na API backend, responsáveis por registrar buscas, cliques em produtos e consultar o histórico de buscas recentes.
