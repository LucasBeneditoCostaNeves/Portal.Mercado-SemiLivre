...
Especificação do endpoint público de listagem de produtos do catálogo, com suporte a filtros de categoria, busca textual, ordenação, filtros avançados, paginação por offset e campos calculados no shape desnormalizado `CatalogProduct`.
